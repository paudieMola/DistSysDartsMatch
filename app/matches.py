...
factory.register_builder('301', t01_match.T01MatchBuilder())
...
my_visit = visit.Visit([(DartMultiplier.SINGLE, 1),
                        (DartMultiplier.SINGLE, 5),
...
my_visit = visit.Visit([(DartMultiplier.TREBLE, 5),
                        (DartMultiplier.SINGLE, 20),
                        (DartMultiplier.SINGLE, 20)])
result, response = x01.process_visit(player2_index, my_visit)
print(response)
...
my_visit = visit.Visit([(DartMultiplier.SINGLE, 0),
                        (DartMultiplier.DOUBLE, 18),
                        (DartMultiplier.SINGLE, 0)])
result, response = x01.process_visit(player1_index, my_visit)
print(response)

# This should trigger an error message and the visit ignored
my_visit = visit.Visit([(DartMultiplier.SINGLE, 10),
                        (DartMultiplier.DOUBLE, 18),
                        (DartMultiplier.SINGLE, 20)])
result, response = x01.process_visit(player2_index, my_visit)
print(response)
